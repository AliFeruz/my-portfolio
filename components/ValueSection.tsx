  ...
  return (
    <div className='w-full h-[632px] flex-shrink-0 bg-white'>
        <div className='flex flex-col px-8 sm:px-16 md:px-32 py-28 relative'>
            ...
            <div className='mt-12 flex gap-5 w-full z-20'>
                <div className=' h-[328px] flex flex-col items-start bg-darkgreen ring-1 ring-lightgreen/20 rounded-lg  p-10'>
            ...
            <div className='overflow-hidden absolute top-0 left-0 w-full h-full'>
                ...
                <Image src={Vector2} alt="background" className=' absolute right-10 bottom-0 w-[400px] h-[400px] object-contain' />
            </div>
        </div>
    </div>
  )
